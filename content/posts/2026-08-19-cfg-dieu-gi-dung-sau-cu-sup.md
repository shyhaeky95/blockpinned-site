---
title: Điều gì đứng sau cú sập 18% của CFG?
tieu_de_ngan: "Điều gì đứng sau cú sập 18% của CFG?"
...
- management fee ước tính của business: **$5,43 triệu/năm**;
- buyback từ quỹ quan sát được: **$0**;
- CFG mới do inflation, quy theo giá lúc đo: khoảng **$2,85 triệu/năm**.
...
- tìm được một giao dịch mà quỹ thực sự dùng tài sản khác để mua CFG trên thị trường;
- rate, period hoặc target của InflationMinter có thể được sửa trực tiếp theo cách hồ sơ hiện chưa ghi nhận;
- xuất hiện một sự kiện khác trong cửa sổ giá giảm có sức giải thích tốt hơn CP172;
- Centrifuge công bố valuation, cap table, báo cáo tài chính hoặc cơ chế rõ ràng cho CFG không chuyển đổi.
...
Đó là một đề xuất buộc holder phải chọn giữa **một token mà buyback từ quỹ chưa từng được quan sát chạy** và **một cổ phần chưa có đủ dữ liệu để định giá**.
